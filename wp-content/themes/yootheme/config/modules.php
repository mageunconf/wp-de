...
return [
    ...
    'fields' => [
        ...
        'style' => [
            ...
            'show' => '$match(position, "top|bottom|sidebar|builder-")',
        ],
        ...
        'title_style' => [
            ...
            'show' => '$match(position, "top|bottom|sidebar|mobile|builder-")',
        ],
        ...
        'text_align_breakpoint' => [
            ...
            'show' => '$match(position, "top|bottom|sidebar|mobile|builder-") && text_align && text_align != "justify"',
        ],
        ...
        'text_align_fallback' => [
            ...
            'show' => '$match(position, "top|bottom|sidebar|mobile|builder-") && text_align && text_align != "justify" && text_align_breakpoint',
        ],
        ...
        'width' => [
            ...
            'show' => '$match(position, "top|bottom|builder-")',
        ],
        ...
        'maxwidth_align' => [
            ...
            'show' => 'maxwidth != "" && $match(position, "top|bottom|builder-")',
        ],
