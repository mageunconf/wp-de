...
function preventClick() {
    var listener = function (e) {
        ...
        remove = function () { return off(doc, 'click', listener, true); },
    ...
    if (youtube || vimeo) {
        ...
        return this.ready = promise(function (resolve) {
            ...
            var loadHandler = function () {
                ...
                off(this$1.el, 'load', loadHandler);
            };

            on(this$1.el, 'load', loadHandler);
            ...
            var msgHandler = function (e) {
                ...
                if ((youtube && data.id === this$1.id && data.event === 'onReady')
