    ...
    <form class="uk-form uk-panel js-form-newsletter" method="post"<?= $this->attrs($attrs_form) ?>>
        ...
        <div<?= $this->attrs($attrs_grid) ?>>
            ...
            <?php if ($element['show_name']) : ?>
                ...
                <div><input<?= $this->attrs($attrs_input) ?> type="text" name="first_name" placeholder="<?= $element['label_first_name'] ?>"></div>
                <div><input<?= $this->attrs($attrs_input) ?> type="text" name="last_name" placeholder="<?= $element['label_last_name'] ?>"></div>
            ...
            <div class="uk-position-relative">
                <button<?= $this->attrs($attrs_button) ?> type="submit" title="<?= $element['label_button'] ?>"></button>
