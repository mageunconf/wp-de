...
if (isset($settings['image_hero_width']) && ($settings['image_hero_width'] != 'auto' || $settings['image_hero_height'] != 'auto')) {
...
<div class="<?php echo $panel; ?> <?php echo $settings['class']; ?>">
    ...
    <div class="uk-panel-teaser uk-cover-background uk-position-relative" style="background-image: url('<?php echo $image; ?>');">
        ...
        <?php if ($settings['panel_title']) : ?>
        <h2><?php echo $settings['panel_title']; ?></h2>
        <?php endif; ?>
