...
// Align Right
$media_width .= ($settings['media_align'] == 'right') ? ' uk-float-right uk-flex-item-auto uk-flex-order-last-' . $settings['media_breakpoint'] : '';
...
<div id="wk-<?php echo $settings['id']; ?>" class="tm-slideshow-uniq <?php echo ($settings['link'] && $settings['link_style'] == 'button-uniq') ? 'tm-button-uniq ' : '' ; echo $class; ?>">
    <div class="uk-panel <?php echo $panel; ?> uk-padding-remove uk-overflow-hidden">
        ...
        <div class="uk-grid uk-grid-collapse <?php echo $content_align; ?>" data-uk-grid-margin>
            <div class="<?php echo $media_width ?> uk-text-center tm-slideshow-uniq-media">
                <?php echo $this->render('plugins/widgets/' . $widget->getConfig('name')  . '/views/_media.php', compact('items', 'settings', 'widget', 'link_style', 'link_target')); ?>
            </div>
            <div class="<?php echo $content_width ?>">
        <?php endif; ?>

        <div class="uk-panel-body uk-text-center" data-uk-slideshow="<?php echo $options; ?>">
            <ul class="uk-slideshow">
                ...
                <li>
                    ...
                    <h3 class="<?php echo $title_size; ?>">
                        ...
                        <?php if ($item['link']) : ?>
                            <a class="uk-link-reset" href="<?php echo $item->escape('link'); ?>" <?php echo $link_target; echo $smoothscroll; ?>><?php echo $item['title']; ?></a>
                        <?php else : ?>
                            <?php echo $item['title']; ?>
                        <?php endif; ?>
                    ...
                    <p class="uk-margin-bottom-remove"><a<?php if($link_style) echo ' class="' . $link_style . '"'; ?> href="<?php echo $item->escape('link'); ?>"<?php echo $link_target; echo $smoothscroll; ?>><?php echo $app['translator']->trans($settings['link_text']); ?></a></p>
                    <?php endif; ?>
