    ...
    <div class="uk-width-medium-3-4">
        ...
        <ul id="nav-content" class="uk-switcher">
            ...
            <li>
                ...
                <div class="uk-form-row">
                    <label class="uk-form-label">{{'Limit Overlay Text' | trans}}</label>
                    <div class="uk-form-controls">
                        <input class="uk-form-width-small" type="text" ng-model="widget.data['excerpt_length']">
                    </div>
                </div>
                ...
                <div class="uk-form-row">
                  ...
                  <div class="uk-form-controls">
                    <select id="wk-badge-style" class="uk-form-width-medium" ng-model="widget.data['badge_style']">
                        ...
                        <option value="uk-badge-success">{{'Success' | trans}}</option>
                        <option value="uk-badge-warning">{{'Warning' | trans}}</option>
                        <option value="uk-badge-danger">{{'Danger' | trans}}</option>
                    </select>
                  </div>
                </div>
            ...
            <h3 class="wk-form-heading">{{'Lightbox' | trans}}</h3>
                ...
                <div class="uk-form-row" ng-if="widget.data.lightbox == 'slideshow'">
                  <label class="uk-form-label">{{'Thumbnails' | trans}}</label>
                  <div class="uk-form-controls">
                      <p class="uk-form-controls-condensed">
                ...
                <h3 class="wk-form-heading" ng-if="widget.data.lightbox == 'slideshow'">{{'Content' | trans}}</h3>

                <div class="uk-form-row" ng-if="widget.data.lightbox == 'slideshow'">
                    <label class="uk-form-label" for="wk-title-size_lightbox">{{'Title Size' | trans}}</label>
                    <div class="uk-form-controls">
                        <select id="wk-title-size_lightbox" class="uk-form-width-medium" ng-model="widget.data['lightbox_title_size']">
                            <option value="panel">{{'Default' | trans}}</option>
                            <option value="h1">H1</option>
                            <option value="h2">H2</option>
                            <option value="h3">H3</option>
                ...
                <div class="uk-form-row" ng-if="widget.data.lightbox == 'slideshow'">
                    <label class="uk-form-label" for="wk-content-size_lightbox">{{'Content Size' | trans}}</label>
                    <div class="uk-form-controls">
                        <select id="wk-content-size_lightbox" class="uk-form-width-medium" ng-model="widget.data['lightbox_content_size']">
                            <option value="">{{'Default' | trans}}</option>
                            <option value="uk-text-small">{{'Small' | trans}}</option>
                            <option value="uk-text-large">{{'Large' | trans}}</option>
                        </select>
                    </div>
                </div>

                <div class="uk-form-row" ng-if="widget.data.lightbox == 'slideshow'">
                    <label class="uk-form-label" for="wk-content-size_lightbox">{{'Content Container' | trans}}</label>
                    <div class="uk-form-controls">
                        <select id="wk-content-size_lightbox" class="uk-form-width-medium" ng-model="widget.data['lightbox_content_container']">
                            <option value="default">{{'Default' | trans}}</option>
                            <option value="uk-width-xlarge-1-3">{{'33%' | trans}}</option>
                            <option value="uk-width-xlarge-1-2">{{'50%' | trans}}</option>
                            <option value="uk-width-xlarge-2-3">{{'66%' | trans}}</option>
                        </select>
                        <p class="uk-form-controls-condensed"><label>On large screens</label></p>
                    </div>
                </div>
